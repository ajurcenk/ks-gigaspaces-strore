...
public class GigaSpacesStateStore<K,V>  implements KeyValueStore<Bytes, byte[]> {
     ...
     * @param typeName
     */
    protected GigaSpacesStateStore(GigaSpace client, String storeName, final String typeName ) {
    ...
    public GigaSpacesStateStore(GigaSpace client, String storeName) {
    ...
    public void put(Bytes key, byte[] value) {
        ...
        if (this.valueSerde != null &&
            ...
            // Deserialize to support strong type (Old logic)
    ...
    public byte[] delete(Bytes key) {
        ...
        // TODO Use ID property for delete document
        ...
        if (document != null) {
            ...
            String strongTypedKey = document.getProperty(STRONG_TYPED_KEY);

            final SQLQuery<SpaceDocument> query =
                    new SQLQuery<SpaceDocument>(this.typeName, "strongTypedKey = ?");

            query.setParameter(1, strongTypedKey);

            final SpaceDocument[] result = this.client.takeMultiple(query);
