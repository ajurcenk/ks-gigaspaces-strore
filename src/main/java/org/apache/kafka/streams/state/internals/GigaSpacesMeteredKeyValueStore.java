...
public class GigaSpacesMeteredKeyValueStore<K, V> extends WrappedStateStore<KeyValueStore<Bytes, byte[]>, K, V>
    ...
    public GigaSpacesMeteredKeyValueStore(final KeyValueStore<Bytes, byte[]> inner,
    ...
    public KeyValueIterator<K, V> range(final K from,
                                        final K to) {
        return new GigaSpacesMeteredKeyValueStore.MeteredKeyValueIterator(
    ...
    public KeyValueIterator<K, V> all() {
        return new GigaSpacesMeteredKeyValueStore.MeteredKeyValueIterator(wrapped().all(), allSensor);
    }
